...
let comment = {
  ...
  queryByUserId: 'SELECT c.*, u.name AS userName, a.title AS anniTitle FROM comments c, users u, annis a WHERE c.userId=? AND c.anniId = a.id AND c.userId=u.id AND c.parentId=0',
